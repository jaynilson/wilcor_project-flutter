...
class ChecksTrailerPage extends StatefulWidget {
  List<InterfaceModel> checks;
  int currentStep;
  bool fromCheckIn;
  dynamic idCheckIn;
  ChecksTrailerPage(this.checks, this.currentStep, this.fromCheckIn,
      {super.key, this.idCheckIn = null});

  @override
  State<ChecksTrailerPage> createState() => _ChecksTrailerPageState();
}

class _ChecksTrailerPageState extends State<ChecksTrailerPage> {
  @override
  void initState() {
    super.initState();
  }

...
class UploadPhotosReportProblemPage extends StatefulWidget {
  const UploadPhotosReportProblemPage({super.key});

  @override
  State<UploadPhotosReportProblemPage> createState() =>
      _UploadPhotosReportProblemPageState();
}

class _UploadPhotosReportProblemPageState
    extends State<UploadPhotosReportProblemPage> {
    ...
    simpleLoading(context, (BuildContext loadingContext) {
      ...
      WebService(context)
          .reportProblemFleet(
              ...
              global_category.toString(),
              provider.user.token ?? "",
              lat: lat,
              lng: lng,
              audio: global_audio_record)
          .then((res) async {
        print("id de report problem");
        print(res);
        for (var i = 0; i < pictureFiles.length; i++) {
          await WebService(context).uploadAsset("report_problem",
              res.toString(), pictureFiles[i], provider.user.token.toString());
        }

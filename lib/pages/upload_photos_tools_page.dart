...
class UploadPhotosToolsPage extends StatefulWidget {
  Function callback;
  UploadPhotosToolsPage(this.callback, {super.key});

  @override
  State<UploadPhotosToolsPage> createState() => _UploadPhotosToolsPageState();
}

class _UploadPhotosToolsPageState extends State<UploadPhotosToolsPage> {

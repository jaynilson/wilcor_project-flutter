...
import 'package:wilcoerp/pages/witness_incident_injury_report_step4_page.dart';

class WitnessIncidentInjuryReportStep3Page extends StatefulWidget {
  const WitnessIncidentInjuryReportStep3Page({super.key});

  @override
  State<WitnessIncidentInjuryReportStep3Page> createState() =>
      _WitnessIncidentInjuryReportStep3PageState();
}

class _WitnessIncidentInjuryReportStep3PageState
    extends State<WitnessIncidentInjuryReportStep3Page> {
  ...
  next() async {
    ...
    Navigator.push(
        context,
        PageTransition(
            child: WitnessIncidentInjuryReportStep4Page(),

...
class RequestToolPage extends StatefulWidget {
  RequestToolPage({super.key});

  @override
  State<RequestToolPage> createState() => _RequestToolPageState();
}
...
class _RequestToolPageState extends State<RequestToolPage> {
  ...
  Widget build(BuildContext context) {
    ToolModel tool = checkout_tool_selected;
                          ...
                          child: Column(
                            children: [
                              FadeInImage.assetNetwork(
                                ...
                                image: imagesUrlTool + tool.picture.toString(),

...
class SelectTrucksCarsRequestPage extends StatefulWidget {
  SelectTrucksCarsRequestPage({super.key});

  @override
  State<SelectTrucksCarsRequestPage> createState() =>
      _SelectTrucksCarsRequestPageState();
}

class _SelectTrucksCarsRequestPageState
    extends State<SelectTrucksCarsRequestPage> {
                ...
                child: ListView(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Column(
                        children: [
                          getItemTemplate("3220", "Hyundai Accent", "P36848",
                              "2011", "MIA", "YARD", true),
                          getItemTemplate("3220", "Hyundai Accent", "P36848",
                              "2011", "MIA", "YARD", true),
                          getItemTemplate("3220", "Hyundai Accent", "P36848",

...
class SelectTrailersRequestPage extends StatefulWidget {
  SelectTrailersRequestPage({super.key});

  @override
  State<SelectTrailersRequestPage> createState() =>
      _SelectTrailersRequestPageState();
}

class _SelectTrailersRequestPageState extends State<SelectTrailersRequestPage> {
